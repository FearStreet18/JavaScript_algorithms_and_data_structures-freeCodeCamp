...
// You need to form a complete sentence using words of your choice, 
...
const wordBlanks = "My "+ myNoun + " is very " + myAdjective + " and it " + myVerb + " very " + myAdverb; // Change this line
